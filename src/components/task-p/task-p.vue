<template>
  <div class="task">
    ...
    <div class="task-btn">
      <el-button type="primary" @click="doneTask">审核通过</el-button>
      <el-button type="primary" @click="notTask">驳回</el-button>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doneTask() {
        this.$http.post('/api/reviewSingleTask.php', qs.stringify({
