<template>
  <div class="project-list">
    <div class="all-project-info">
      <div class="info-item">
        <p style="color: #000">{{this.allTaskInfo.allTaskNum}}</p>
      </div>
      <div class="info-item">
        <p style="color: #409EFF">{{this.allTaskInfo.finishedTaskNum}}</p>
      </div>
      <div class="info-item">
        <p style="color: #f56c6c">{{this.allTaskInfo.waitTaskNum}}</p>
      </div>
      <div class="info-item">
        <div class="info-circle">
          <el-progress :width="40" type="circle" :percentage="this.allTaskInfo.finishRate
" color="#f56c6c"></el-progress>
    ...
    <div class="project-con" v-for="item in projects" v-bind:project="item" v-bind:key="item.projectId">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getInfo() {
        this.$http.post('/api/showWaitProject.php', qs.stringify({
            id: this.id
          }))
          .then(res => {
